...
<div style="max-width:560px;margin:auto;background:#1A1A2E;border-radius:12px;overflow:hidden;border:1px solid rgba(192,192,192,0.1)">
  <div style="padding:24px 32px;background:#0A0A0F;border-bottom:1px solid rgba(192,192,192,0.1)">
    <span style="color:#009f4b;font-size:20px;font-weight:600">Xmoso</span>
  ...
  <div style="padding:32px">
    ...
    <div style="margin-top:24px;text-align:center">
      <a href="https://xmoso.com/admin/inquiries" style="display:inline-block;padding:10px 24px;background:#009f4b;color:#0A0A0F;text-decoration:none;border-radius:8px;font-size:13px;font-weight:500">→ View in Admin</a>
    </div>
  </div>
</div></body></html>`;
}

...
const COLORS = [
  "#ffffff", "#C0C0C0", "#009f4b", "#7EC8E3", "#e8c87e", "#ffc107", "#f44336",
  ...
  return (
    <div className="quill-wrapper" style={{ minHeight }}>
      <style>{`
        ...
        .ql-active .ql-stroke { stroke: #009f4b !important; }
        .ql-picker-options {
      ...
      <div className="flex items-center gap-2 px-3 py-2 bg-[#14142a] border border-t-0 border-silver/10 rounded-b-lg flex-wrap">
        ...
        {["#009f4b", "#7EC8E3", "#e8c87e", "#ffc107", "#ffffff", "#C0C0C0", "#333333", "#000000"].map((c) => (
          <button
            key={c}
            type="button"

        ...
        {loading ? (
          ...
          <div className="max-w-lg space-y-8">
            ...
            <div className="bg-deep-blue/30 border border-silver/10 rounded-xl p-6">
              ...
              {/* Copyright Text */}
              <p className="text-xs text-silver/50 mb-2 mt-6">Copyright Text</p>
              <div className="flex gap-2">
                <input value={copyrightText} onChange={(e) => setCopyrightText(e.target.value)}
                  placeholder="© 2026 Xmoso. All rights reserved."
                  className="flex-1 bg-deep-dark border border-silver/10 rounded px-3 py-2 text-sm text-white" />
                <Button size="sm" onClick={async () => { await saveSetting("copyright_text", copyrightText); }}>Save</Button>
              </div>
            </div>

          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-deep-blue/30 border border-silver/10 rounded-xl p-6">
                ...
                {inquiryTrend.length > 0
                  ? <Line data={{ labels: inquiryTrend.map((v) => v.date), datasets: [{ label: "Inquiries", data: inquiryTrend.map((v) => v.count), borderColor: "#009f4b", backgroundColor: "rgba(139,200,160,0.1)", tension: 0.3 }] }} options={CHART_OPTS} />

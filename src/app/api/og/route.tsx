  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {showProduct ? (
          <>
            ...
            <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                <div style={{ width: 36, height: 36, borderRadius: 8, background: "#009f4b", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, fontWeight: 700, color: "#0A0A0F" }}>{initial}</div>
                <span style={{ fontSize: 22, color: "#009f4b", fontWeight: 300, letterSpacing: "0.1em" }}>{brand}</span>
              </div>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
              <div style={{ width: 44, height: 44, borderRadius: 10, background: "#009f4b", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24, fontWeight: 700, color: "#0A0A0F" }}>{initial}</div>
              <span style={{ fontSize: 28, color: "#009f4b", fontWeight: 300, letterSpacing: "0.1em" }}>{brand}</span>
            </div>
        ...
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 4, background: "linear-gradient(90deg, #009f4b 0%, #7EC8E3 50%, #009f4b 100%)" }} />

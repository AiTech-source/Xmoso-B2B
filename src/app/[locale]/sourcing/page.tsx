            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {(pageData?.content?.capabilities?.length
                ...
                : [
                    ...
                    { icon: "🏭", title: isZh ? "研发试产与小批量" : "Pilot Workshop & Batches", desc: isZh ? "约 1,250 平方米研发试产场地和一条小批量生产线，支持样品验证、小批量试单和结构验证。根据产品结构和生产安排，日产量最高可达约 60 台。" : "A 1,250 m2 pilot workshop with one active production line supports R&D validation, sample builds and small-batch trial production. Daily output can reach up to 60 units depending on model mix." },

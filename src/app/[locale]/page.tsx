...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: desc,
      images: [{ url: ogImageUrl({ title: "Less Appliances, Natural More", subtitle: "Precision Wine Cooling Cabinets", type: "page", brand: ogSet.brand, url: ogSet.siteUrl }), width: 1200, height: 630 }],
    },
  };
}
